...
public final class Constants {
    ...
    public static final Account ACCOUNT_1_MOCK = new Account(USER_1_MOCK, 12345L, new Date(), 500000f, 500000f, AccountType.CURRENT_ACCOUNT);
    public static final Account ACCOUNT_2_MOCK = new Account(USER_2_MOCK, 12344L, new Date(), 100000f, 100000f, AccountType.CURRENT_ACCOUNT);
